...
// Images of warehouse buildings with electrical installations
import h1 from "./images/warehouse2.jpeg";
import h2 from "./images/warehouse3.jpeg";
import h3 from "./images/warehouse4.jpeg";
import h4 from "./images/warehouse5.jpeg";

import h5 from "./images/warehouse6.jpeg";
import h6 from "./images/warehouse7.jpeg"
...
const Warehouse = () => {
  ...
  return (
    <div className="w-full bg-white shadow-md">
      ...
      <img
        src={h1}
        alt="warehouse Building Electrical Installation"
      ...
      <div className="px-6 py-10 text-gray-800 space-y-8 text-justify leading-relaxed tracking-normal">
        <h1 className="text-4xl md:text-5xl font-bold text-center">
          Our Electrical Installation for <span className="text-orange-600">Warehouse</span> Buildings
        </h1>

        <p>
          At UrbanVolt Solutions, we specialize in providing high-quality electrical installations for warehouse buildings.
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-3">Why Choose Us for warehouse Electrical Installations?</h2>
          <ul className="space-y-4 list-disc pl-6">
            ...
            <li><strong>Expert Technicians:</strong> Our team consists of skilled electricians with years of experience in warehouse electrical systems.</li>
        ...
        <div className="bg-gray-200 rounded-lg p-4"> 
          ...
          <h2 className="text-2xl font-semibold  mb-3">Previous Warehouse Projects</h2>
          <p className="mb-6">
            Take a look at some of the warehouse buildings we've worked on. Our expertise in electrical installations has helped many homeowners enjoy a safe and well-lit environment.
          </p>
          </div>
