...
// Images of Learning  with electrical installations
import h1 from "./images/learn.jpeg";
import h2 from "./images/learn2.jpeg";
import h3 from "./images/learn3.jpeg";
import h4 from "./images/el7.jpeg";

import h5 from "./images/el5.jpeg";
...
const Learning = () => {
  ...
  return (
    <div className="w-full bg-white shadow-md">
      ...
      <img
        src={h1}
        alt="Learning institution Electrical Installation"
      ...
      <div className="px-6 py-10 text-gray-800 space-y-8 text-justify leading-relaxed tracking-normal">
        <h1 className="text-4xl md:text-5xl font-bold text-center">
          Our Electrical Installation for <span className="text-orange-600">Learning</span> Institution
        </h1>

        <p>
          At UrbanVolt Solutions, we specialize in providing high-quality electrical installations for learning institution.
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-3">Why Choose Us for learning institution Electrical Installations?</h2>
          <ul className="space-y-4 list-disc pl-6">
            ...
            <li><strong>Expert Technicians:</strong> Our team consists of skilled electricians with years of experience in learning institution electrical systems.</li>
        ...
        <div className="bg-gray-200 rounded-lg p-4"> 
          ...
          <h2 className="text-2xl font-semibold  mb-3">Previous learning institution Projects</h2>
          <p className="mb-6">
            Take a look at some of the learning institution we've worked on. Our expertise in electrical installations has helped many homeowners enjoy a safe and well-lit environment.
          </p>
          </div>
              ...
              >
                {images.map((img, index) => (
                  <div key={index} className="w-full h-full flex-shrink-0 flex items-center justify-center">
                    <img
                      src={img}
                      alt={`learning institution ${index + 1}`}
