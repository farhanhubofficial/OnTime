...
import h1 from "./images/ResBuilding.jpeg"; 
import h2 from "./images/ResBuilding.jpeg"; 
import h3 from "./images/ResBuilding.jpeg"; 
import h4 from "./images/ResBuilding.jpeg"; 
import h5 from "./images/ResBuilding.jpeg"; 
import h6 from "./images/ResBuilding.jpeg";
...
const Residential = () => {
  ...
  // Function to navigate to the previous image in the slider
  const goToPrev = () => {
    setCurrentIndex((prev) => (prev === 0 ? images.length - 1 : prev - 1));
  };

  // Function to navigate to the next image in the slider
  const goToNext = () => {
  ...
  return (
    <div className="w-full bg-white shadow-md">
      ...
      <div className="px-6 py-10 text-gray-800 space-y-8 text-justify leading-relaxed tracking-normal">
        ...
        <p>
          At UrbanVolt Solutions, we specialize in providing high-quality electrical installations for residential buildings. Our services are designed to ensure safety, efficiency, and sustainability, meeting all the necessary requirements for modern homes.
        </p>
        ...
        <div>
          ...
          <ul className="space-y-4 list-disc pl-6">
            <li>
              <strong>Safety First:</strong> We prioritize safety in all our electrical installations, ensuring compliance with local electrical codes and regulations.
            </li>
            <li>
              <strong>Expert Technicians:</strong> Our team consists of skilled electricians with years of experience in residential electrical systems.
            </li>
            <li>
              <strong>Efficient Solutions:</strong> We use the latest technology and efficient installation techniques to save time and energy.
            </li>
          </ul>
        </div>
