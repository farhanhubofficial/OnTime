...
// Images of commercial buildings with electrical installations
import h1 from "./images/commercial1.jpeg";
import h2 from "./images/commercial2.jpeg";
import h3 from "./images/commercial3.jpeg";
import h4 from "./images/commercial4.jpeg";

import h5 from "./images/commercial5.jpeg";
import h6 from "./images/comBuilding.jpeg";
import h7 from "./images/combuilding2.jpeg";
import h8 from "./images/commbuilding3.jpeg";
    ...
    <div className="w-full bg-white shadow-md">
      ...
      <div className="px-6 py-10 text-gray-800 space-y-8 text-justify leading-relaxed tracking-normal">
        <h1 className="text-4xl md:text-5xl font-bold text-center">
          Our Electrical Installation for <span className="text-orange-600">Commercial</span> Buildings
        </h1>

        <p>
          At UrbanVolt Solutions, we specialize in providing high-quality electrical installations for commercial buildings.
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-3">Why Choose Us for commercial Electrical Installations?</h2>
          <ul className="space-y-4 list-disc pl-6">
            ...
            <li><strong>Expert Technicians:</strong> Our team consists of skilled electricians with years of experience in commercial electrical systems.</li>
        ...
        <div className="bg-gray-200 rounded-lg p-4"> 
          ...
          <h2 className="text-2xl font-semibold  mb-3">Previous commercial Projects</h2>
          <p className="mb-6">
            Take a look at some of the commercial buildings we've worked on. Our expertise in electrical installations has helped many homeowners enjoy a safe and well-lit environment.
          </p>
          </div>
